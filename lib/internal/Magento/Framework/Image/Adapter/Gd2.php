...
class Gd2 extends AbstractAdapter
{
    ...
    public function save($destination = null, $newName = null)
    {
        ...
        $outputImageType = $this->getEffectiveImageType();
        ...
        call_user_func_array($this->_getCallback('output', $outputImageType), $functionParameters);
    }
    ...
    {
        ob_start();
        call_user_func($this->_getCallback('output', $this->getEffectiveImageType()), $this->_imageHandler);
        return ob_get_clean();
    }
